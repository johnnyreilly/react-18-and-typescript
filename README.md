...
![a screenshot of the Property 'createRoot' does not exist error](images/createNode-error.png)
...
![a screenshot of the null is not assignable error](images/null_is_not_assignable-error.png)
